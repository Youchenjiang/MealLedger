-- Fix the PL/pgSQL variable/column name collision in the transfer bundle RPC.
-- This forward-only migration keeps the already-applied 0001 migration immutable.
