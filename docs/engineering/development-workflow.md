...
Medium or high-risk product work should follow the [Spec-Driven Workflow](spec-driven-workflow.md) before implementation. This is required for ledger correctness, import/export, privacy, sync, and cross-module data contracts.
