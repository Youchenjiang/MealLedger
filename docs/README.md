# MealLedger Documentation

Use this index as the starting point for review. The documentation is grouped by decision level so product, V1 implementation, engineering, and testing concerns do not compete in one flat folder.
...
- [Import and export spec](v1/import-export-spec.md)
...
- [Email delivery (Resend + Supabase SMTP)](engineering/email-delivery.md)
...
- [Voice capture tasks](specs/voice-capture/tasks.md)
- [Voice capture test plan](specs/voice-capture/test-plan.md)
...
- [Localization requirements (planned)](specs/localization/requirements.md)
...
- [Settings tasks](specs/settings/tasks.md)
- [Settings test plan](specs/settings/test-plan.md)
...
2. Accounting rules.
3. Import and export spec.
4. Data lifecycle.
5. Technical operations.
6. Privacy checklist.
7. Accounting test plan.
